...
public class FinReport extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		StringBuilder sql = new StringBuilder ("INSERT INTO T_Report "
			...
			+ "SELECT ").append(getAD_PInstance_ID()).append(", rl.PA_ReportLine_ID, 0,0, rl.SeqNo,0, CASE WHEN LineType='B' THEN '' ELSE substring(NVL(trl.Name, rl.Name),0,50) END as Name, NVL(trl.Description,rl.Description) as Description "
